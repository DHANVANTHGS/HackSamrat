...
const assertUploadMedicalRecordDto = (body) =>
  assertDto(
    body,
    (value) => {
      if (!isObject(value)) {
    ...
    "Medical record upload requires title, valid record type, and a valid occurredAt date when provided.",
  );

module.exports = {
  assertUploadMedicalRecordDto,
};
